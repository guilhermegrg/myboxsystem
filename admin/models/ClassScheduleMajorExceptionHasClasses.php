...
/** 
TABLE:  class_schedule_major_exceptions_has_classes
*/
class ClassScheduleMajorExceptionHasClasses extends SimpleRelationModel {

    /** 
    TYPE: int(11) NOT NULL
    RELATION: PARENT_ID
    */
    public $class_schedule_major_exception_id;
