...
/** 
TABLE:  staff_has_coach_profile
CUSTOM_SELECT_QUERY: SELECT {tableName.fields}, coach_profiles.name as coach_profile_name FROM {tableName} LEFT JOIN coach_profiles ON {tableName}.coach_profile_id=coach_profiles.id
*/
class StaffHasCoachProfile extends SimpleRelationModel {
