...
include "email_template_create_process.php";
...
?>
  ...
  <form action="email_template_create_view.php" method="post" >
...
<!--
    ...
    <div class="form-group form-check">
        <input type="checkbox" class="form-check-input" name="active" <?php  echo $email->active? "checked":"";?>>
